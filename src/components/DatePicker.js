...
export default class DatePicker extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            inputJalaaliFormat: this.props.inputJalaaliFormat || this.getInputFormat(false, this.props.timePicker),
            ...
            timePickerComponent: this.getTimePickerComponent(),
            setTodayOnBlur: this.props.setTodayOnBlur
        };
    }

    getTimePickerComponent() {
        return this.props.timePicker ? (this.props.custom_timepicker ? this.props.custom_timepicker : MyTimePicker) : undefined
    }
